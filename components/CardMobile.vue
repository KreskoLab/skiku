    ...
    <div class="card-content">
      ...
      <div class="content has-text-centered" style="margin-top:-10px">
        ...
        <div v-if="store.name == 'Сільпо' ">
          ...
          <b-tag v-if="!good.promotion" type="is-success is-light">
          ...
          <b-tag v-else type="is-danger is-light">
            <span class="is-size-5">
              <грн> {{good.price}} 
              <span class="is-size-6"> до {{ good.priceStopAfter.toString().substr(0, 5) }} </span> 
            </span>
          </b-tag>
        ...
        <div v-else>
          ...
          <b-tag v-if="good.discount.status" type="is-danger is-light">
            <span class="is-size-5">
              <грн> {{ good.price.toString().substring(0, good.price.toString().length - 2) + '.' + good.price.toString().slice(-2) }}
